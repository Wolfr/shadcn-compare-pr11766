...
function ButtonGroupText({
  ...
  return (
    <Comp
      className={cn(
        "flex items-center gap-2 border border-transparent border-b-border bg-transparent px-2.5 text-xs font-semibold uppercase group-has-[>[data-variant=outline]]/button-group:border-border [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-3.5",
        className
      )}
      {...props}
    />
